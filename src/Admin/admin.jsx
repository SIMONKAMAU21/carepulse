...
const Admin = () => {
    ...
    return (
      <Box bg={"#131619"} color={"white"} w={"100vw"} h={"100vh"} p={4}>
        {/* Other components like header and stats */}
        <HStack p={4} bg={"black"}>
        <Image src={logo} />
        <Spacer />
      </HStack>
...
<SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
        ...
        {/* Modal for scheduling/canceling */}
            ...
            <ModalBody>
              {isScheduleModal ? (
                <Input
                  type="date"
                  value={
                    appointments.documents[selectedAppointmentIndex]?.selectedDate || ""
                  }
                ...
                <Textarea
                  ...
                  value={
                    appointments.documents[selectedAppointmentIndex]?.cancelReason || ""
                  }
