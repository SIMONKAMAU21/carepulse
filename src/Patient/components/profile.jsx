    ...
    <>
      ...
      <AuthWrapper
        leftChildren={
          ...
          >
            <Box onClick={goBack}  borderRadius={"10px"} border={"2px solid green"} h={"3%"} display={"flex"} alignItems={"center"} position={"fixed"} mt={{ base: "20%", md: "4%" }}>
              <Icon fontWeight={"700"} fontSize={"25px"}  color={colorMode === "dark" ? "green.400" : "green.400"} as={MdChevronLeft} />
            </Box>
